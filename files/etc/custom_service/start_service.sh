...
sleep 10
rclone mount onedrive:/ /mnt/onedrive --config /docker/rclone/rclone.conf --copy-links --allow-other --allow-non-empty --umask 000 --daemon
sleep 10
rclone mount aliyun:/ /mnt/aliyun --config /docker/rclone/rclone.conf --copy-links --allow-other --allow-non-empty --umask 000 --daemon
